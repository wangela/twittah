...
public class ComposeActivity extends Activity {
	...
	public void loadUser() {
		ProgressBar pb = (ProgressBar) findViewById(R.id.pbComposePic);
		...
		client.getMyProfile(new JsonHttpResponseHandler() {
			...
			public void onSuccess(org.json.JSONObject userObject) {
				...
				ivUserPic.setVisibility(ImageView.VISIBLE);
				tvUserFull.setVisibility(TextView.VISIBLE);
				tvUserHandle.setVisibility(TextView.VISIBLE);
			};
	...
	public void onTweet() {
		...
		Toast.makeText(this, "Tweet to post: " + tweetText, Toast.LENGTH_LONG)
				.show();
